...
import 'package:marcosmhs/features/main/visualizations/public_area/home_desktop.dart';
import 'package:marcosmhs/features/main/visualizations/public_area/home_mobile.dart';
...
class _LandingScreenState extends State<LandingScreen> {
  ...
  Widget build(BuildContext context) {
    if (_initializing == true) {
      MainSiteController().loadSiteMainData().then((value) {
