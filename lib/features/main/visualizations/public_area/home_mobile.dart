...
import 'package:marcosmhs/features/main/visualizations/public_area/home_areas/about_text.dart';
...
import 'package:marcosmhs/features/main/visualizations/public_area/home_areas/header_area_mobile.dart';
import 'package:marcosmhs/features/main/visualizations/public_area/home_areas/profile_foto_area.dart';
  ...
  Widget build(BuildContext context) {
    if (_initializing) {
      ...
      if (widget.siteMainData.aboutMeAreaTitle.isNotEmpty) {
        ...
        if (widget.siteMainData.articleAreaTitle.isNotEmpty) {
          MainSiteController().loadProjectList().then((value) => setState(() => _projectList = value));
        }
      }
